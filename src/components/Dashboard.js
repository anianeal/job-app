  ...
  return (
    <div>
       ...
       <div className="header">
          <div className="logo"><span className="text-gradient">Aicareer</span></div>
       </div>
       ...
       <div className="wrapper">
           ...
           <div className="main-container">
               <div className="search-type">
                   ...
                   <div className="job-time">
                       ...
                       <div className="job-wrapper">
                           <div className="type-container">
                               ...
                               <label for="job1">Entry Level</label>
                               <span className="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">Mid Level</label>
                               <span className="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">Senior Level</label>
                               <span className="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">Management Level</label>
                               <span className="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">Internship</label>
                               <span className="job-number">56</span>
                           </div>
                       </div>
                   </div>
                   ...
                   <div className="job-time">
                       <div className="job-time-title">Salary</div>
                       <div className="job-wrapper">
                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">$30,000 - $40,000</label>
                               <span className="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">$40,000 - $50,000</label>
                               <span className="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">$50,000 - $60,000</label>
                               <span className="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">$60,000 - $70,000</label>
                               <span className="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">$70,000 - $80,000</label>
                               <span className="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">$80,000 - $90,000</label>
                               <span className="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">$90,000 - $100,000</label>
                               <span class="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">$100,000 - $120,000</label>
                               <span class="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">$120,000 - $150,000</label>
                               <span class="job-number">56</span>
                           </div>
                       </div>
                   </div>
                   ...
                   <div className="job-time">
                       <div className="job-time-title">Category</div>
                       <div className="job-wrapper">
                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">Administrative</label>
                               <span class="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">Data and Analytics</label>
                               <span class="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">Design</label>
                               <span class="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">IT</label>
                               <span class="job-number">56</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" checked />
                               <label for="job1">Software Engineer</label>
                               <span class="job-number">56</span>
                           </div>
                       </div>
                   </div>
                   ...
                   <div className="job-time">
                       ...
                       <div className="job-wrapper">
                           <div className="type-container">
                               ...
                               <label for="job1">Alaska</label>
                               <span class="job-number">49</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" />
                               <label for="job1">Arkansas</label>
                               <span class="job-number">49</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" />
                               <label for="job1">California</label>
                               <span class="job-number">49</span>
                           </div>

                           <div className="type-container">
                               <input type="checkbox" id="job1" class="job-style" />
                               <label for="job1">Texas</label>
                               <span class="job-number">49</span>
                           </div>
                       </div>
                   </div>
               ...
               <div className="searched-jobs">
                   <div className="searched-bar">
                       ...
                       <div className="searched-sort">Sort by: <span class="post-time">Newest Post</span><span class="menu-icon">▼</span></div>
                   </div>

                   <div className="job-cards">
                       <div className="job-card">
                           <div className="job-card-header">
                               <svg viewBox="0 -13 512 512" xmlns="http://www.w3.org/2000/svg" style={{background: '#2e2882'}}>
                                  <g fill="#feb0a5">
                           ...
                           <div className="job-card-subtitle">The User Experience Designer position exists to create compelling and digital user experience through excellent design...</div>
                       ...
                       <div className="job-card">
                           <div className="job-card-header">
                               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" style={{background: '#f76754'}}>
                       ...
                       <div className="job-card">
                           <div className="job-card-header">
                               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#fff" style={{background: '#55acee'}}>
                       ...
                       <div className="job-card">
                           <div className="job-card-header">
                               <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#fff" style={{background: '#1e1f26'}}>
                       ...
                       <div className="job-card">
                           <div className="job-card-header">
                               <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{background: '#1e1f26'}}>
                       ...
                       <div className="job-card">
                           <div className="job-card-header">
                               <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{background: '#fe5b5f'}}>
                       ...
                       <div className="job-card">
                           <div className="job-card-header">
                               <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{background: '#5c6bc0'}}>
                       ...
                       <div className="job-card">
                           <div className="job-card-header">
                               <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{background: '#ea4c88'}}>
                   ...
                   <div className="job-overview">
                       <div className="job-overview-cards">
                           <div className="job-overview-card">
                               <div className="job-card overview-card">
                                   <div className="overview-wrapper">
                                       ...
                                       <svg className="heart" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
                           ...
                           <div className="job-overview-card">
                               <div className="job-card overview-card">
                                   <div className="overview-wrapper">
                                       <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style={{background: '#f76754'}}>
                                          <path xmlns="http://www.w3.org/2000/svg" d="M0 .5h4.2v23H0z" fill="#042b48" data-original="#212121" />
                                          <path xmlns="http://www.w3.org/2000/svg" d="M15.4.5a8.6 8.6 0 100 17.2 8.6 8.6 0 000-17.2z" fill="#fefefe" data-original="#f4511e" />
                                       </svg>
                                       <div className='overview-detail'>
                           ...
                           <div className="job-overview-card">
                               <div className="job-card overview-card">
                                   <div className="overview-wrapper">
                                       <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="#fff" style={{background: '#55acee'}}>
                                          <path d="M512 97.2c-19 8.4-39.3 14-60.5 16.6 21.8-13 38.4-33.4 46.2-58a209.8 209.8 0 01-66.6 25.4A105 105 0 00249.5 153c0 8.3.8 16.3 2.5 24A297.1 297.1 0 0135.6 67 105.1 105.1 0 0068 207.4c-16.9-.3-33.4-5.2-47.4-12.9v1.1c0 51 36.4 93.4 84 103.2-8.5 2.3-17.8 3.4-27.4 3.4-6.8 0-13.5-.3-20-1.8a106 106 0 0098.2 73.2A211 211 0 010 416.9 295.5 295.5 0 00161 464c193.2 0 298.8-160 298.8-298.7 0-4.6-.2-9.1-.4-13.6A209.4 209.4 0 00512 97.2z" />
                                       </svg>
                                       <div className='overview-detail'>
                                           <div className="job-card-title">User Experience Designer</div>
                           ...
                           <div className="job-overview-card">
                               <div className="job-card overview-card">
                                   <div className="overview-wrapper">
                                       <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{background: '#ffe80f'}}>
                                          <path d="M9.5 9.3l-.7 2h1.4z" />
                                          <path d="M12 1C5.4 1 0 5.2 0 10.4c0 3.4 2.2 6.3 5.6 8-1.3 4.4-1.3 4.4-1 4.6.2.1.5 0 5.3-3.4l2.1.2c6.6 0 12-4.2 12-9.4S18.6 1 12 1zM6 13c0 .4-.3.7-.6.7s-.7-.3-.7-.7V9H3.6c-.4 0-.7-.4-.7-.7s.3-.7.7-.7H7c.4 0 .7.3.7.7s-.3.6-.7.6h-1zm5.4.7c-.7 0-.6-.6-.9-1.2h-2c-.4.6-.3 1.2-1 1.2s-.8-.4-.6-1.1l1.6-4.3a1 1 0 011-.7c.4 0 .8.3.9.7 1 3.4 2.6 5.4 1 5.4zm4-.1h-2.2c-1.2 0-.5-1.6-.7-5.3 0-.4.3-.7.7-.7s.7.3.7.7v4h1.5c.3 0 .6.3.6.6 0 .4-.3.7-.6.7zm5.4-.5l-.3.4c-1 .7-1.6-1.4-2.6-2.3l-.2.3V13c0 .4-.3.7-.7.7a.7.7 0 01-.7-.7V8.3a.7.7 0 011.4 0v1.5c1.3-1 2-2.7 2.8-2 .8.9-.9 1.6-1.5 2.5 1.6 2.2 1.9 2.3 1.8 2.8z" />
                                       </svg>
                                       <div className='overview-detail'>
                       ...
                       <div className="job-explain">
                           ...
                           <div className="job-logos">
                               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" style={{background: '#ea4c88'}}>
